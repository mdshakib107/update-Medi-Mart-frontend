...
const blogs = [
  ...
  },
  {
    ...
    description:
      "Dive deep into the realm of artificial intelligence (AI) and its transformative influence on industries, society, and our daily lives. Explore machine learning, natural language processing, and the ethical considerations surrounding AI development.",
    publish_date: "2025-03-05",
    author_name: "Samin Israr Ravi",
    blog_image:
      "https://cdn.bulbapp.io/frontend/images/c503fc5c-bebd-4985-8400-3b5b3259405e/1",
    total_likes: "1350",
  },
  {
    id: "6",
